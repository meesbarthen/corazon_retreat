      ...
      <div className="mx-auto max-w-7xl px-8">
        <div className="mx-auto max-w-4xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 font-sans mb-10">
            ...
            november 2023. Vanaf donderdagavond of uiterlijk vrijdagochtend
            11.00 uur zijn jullie welkom en is er gelegenheid om het huis en de
            omgeving te verkennen, zodat jullie je snel thuis voelen. De eerste
            ceremonie begint vrijdag rond 13.00 uur. Op 28 november hebben we
            nog ons laatste ontbijt samen en sluiten we af met een eindceremonie
